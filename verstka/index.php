	...
	<section class="content">
		<div class="section section_main">
			<div class="main_slider carousel" data-items-xl="1" data-items-lg="1" data-items-md="1" data-items-sm="1" data-scroll-xl="1" data-scroll-lg="1" data-scroll-md="1" data-scroll-sm="1" data-slick='{"dots": true, "fade": false}'>
				<div class="slider_item" style="background: url('img/main_slider_bg_1.webp') center no-repeat; background-size: cover;">
					<div class="container">
				...
				<div class="slider_item" style="background: url('img/main_slider_bg_2.webp') center no-repeat; background-size: cover;">
					<div class="container">
						<h1 class="main_slider__title">
							<span>GKHAIR</span>
							ОФИЦИАЛЬНАЯ <br> ПРОДУКЦИЯ
				...
				<div class="slider_item" style="background: url('img/main_slider_bg_3.webp') center no-repeat; background-size: cover;">
					<div class="container">
						<h1 class="main_slider__title">
							<span>GKHAIR</span>
							ОФИЦИАЛЬНАЯ <br> ПРОДУКЦИЯ
			...
			<div class="container">
				<div class="previlegues_block">
					<div class="previlegues_item">
						<img data-src="img/previlegues_1.png" alt="">
					...
					<div class="previlegues_item">
						<img data-src="img/previlegues_2.png" alt="">
						<p class="previlegues_title">
							БЕСПЛАТНАЯ ДОСТАВКА
						</p>
						<p class="previlegues_descr">
					...
					<div class="previlegues_item">
						<img data-src="img/previlegues_3.png" alt="">
						<p class="previlegues_title">
							СКИДКА 5%
						</p>
						<p class="previlegues_descr">
					...
					<div class="previlegues_item">
						<img data-src="img/previlegues_4.png" alt="">
						<p class="previlegues_title">
							СПЕЦИАЛЬНЫЕ УСЛОВИЯ
						</p>
						<p class="previlegues_descr">
				...
				<div class="product_list__wrapper">
					<div class="product_list__left">
						<div class="product_list__item">
							...
							<img data-src="img/product_list_1.png" alt="" class="product_list_img">
						</div>
					</div>
					<div class="product_list__right">
						<div class="product_list__right__branch">
							<div class="product_list__item product_list__item__branch">
								...
								<img data-src="img/product_list_2.png" alt="" class="product_list_img">
							</div>
							<div class="product_list__item product_list__item__branch">
								...
								<img data-src="img/product_list_3.png" alt="" class="product_list_img">
							</div>
						</div>
						<div class="product_list__item product_list__item__bottom">
							...
							<img data-src="img/product_list_4.webp" alt="" class="product_list_img">
						</div>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="about_item_wrapper">
					<div class="about_item">
						<img data-src="img/guarantee_1.png" alt="">
					...
					<div class="about_item">
						<img data-src="img/guarantee_2.png" alt="">
						<div class="about_item_right">
							<p class="about_item__title">
					...
					<div class="about_item">
						<img data-src="img/guarantee_3.png" alt="">
						<div class="about_item_right">
							<p class="about_item__title">
								БЕЗОПАСНОСТЬ
							</p>
					...
					<div class="about_item">
						<img data-src="img/guarantee_4.png" alt="">
						<div class="about_item_right">
							<p class="about_item__title">
								ЭКОНОМИЧНОСТЬ
							</p>
				...
				<div class="product_top_slider__wrapper">
					<div class="product_top_slider carousel" data-items-xl="4" data-items-lg="3" data-items-md="2" data-items-sm="1" data-scroll-xl="1" data-scroll-lg="1" data-scroll-md="1" data-scroll-sm="1" data-slick='{"dots": false, "fade": false}'>
						<div class="slider_item">
							...
							<div class="product_item">
								<div class="product_image">
									<img data-src="img/product_2.jpg" alt="" class="product_img">
									<div class="user_action__block">
										<a href="#" data-toggle="modal" data-target="#moreModal">
											<img data-src="img/search_icon.png" alt="">
										</a>
						...
						<div class="slider_item">
							...
							<div class="product_item">
								<div class="product_image">
									<img data-src="img/product_3.png" alt="" class="product_img">
									<div class="user_action__block">
										<a href="#" data-toggle="modal" data-target="#moreModal">
											<img data-src="img/search_icon.png" alt="">
										</a>
						...
						<div class="slider_item">
							...
							<div class="product_item">
								<div class="product_image">
									<img data-src="img/product_4.png" alt="" class="product_img">
									<div class="user_action__block">
										<a href="#" data-toggle="modal" data-target="#moreModal">
											<img data-src="img/search_icon.png" alt="">
										</a>
				...
				<div class="section_video__wrapper">
					<div class="main_video">
						<a href="#" class="video_block">
							<img data-src="img/video_poster_1.jpg" alt="" class="video_poster">
							<span class="play_btn">
								<img data-src="img/play_btn.png" alt="">
							</span>
						</a>
					</div>
					...
					<div class="row">
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<a href="#" class="video_block video_block__small">
								<img data-src="img/video_poster_2.jpg" alt="" class="video_poster">
								<span class="play_btn">
									<img data-src="img/play_btn.png" alt="">
								</span>
							</a>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<a href="#" class="video_block video_block__small">
								<img data-src="img/video_poster_3.jpg" alt="" class="video_poster">
								<span class="play_btn">
									<img data-src="img/play_btn.png" alt="">
								</span>
							</a>
						...
						<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
							<a href="#" class="video_block video_block__small">
								<img data-src="img/video_poster_4.jpg" alt="" class="video_poster">
								<span class="play_btn">
									<img data-src="img/play_btn.png" alt="">
								</span>
							</a>
			...
			<div class="container">
				...
				<div class="news_slider_wrapper">
					<div class="news_slider carousel" data-items-xl="3" data-items-lg="3" data-items-md="2" data-items-sm="1" data-scroll-xl="1" data-scroll-lg="1" data-scroll-md="1" data-scroll-sm="1" data-slick='{"dots": false, "fade": false}'>
						<div class="slider_item">
							<div class="news_item">
								<img data-src="img/news_1.jpg" alt="" class="news_img">
								<p class="news_title">
						...
						<div class="slider_item">
							<div class="news_item">
								<img data-src="img/news_2.jpg" alt="" class="news_img">
								<p class="news_title">
						...
						<div class="slider_item">
							<div class="news_item">
								<img data-src="img/news_3.jpg" alt="" class="news_img">
								<p class="news_title">
				...
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
						<a href="#" class="info_item">
							<img data-src="img/info_1.jpg" alt="" class="info_img">
					...
					<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
						<a href="#" class="info_item">
							<img data-src="img/info_2.jpg" alt="" class="info_img">
							<span class="info_title">
		...
		<div class="section section_partners">
			<div class="container">
				...
				<div class="partners_block">
					<a href="#">
						<img data-src="img/partner_1.png" alt="">
					</a>
					<a href="#">
						<img data-src="img/partner_2.png" alt="">
					</a>
					<a href="#">
						<img data-src="img/partner_3.png" alt="">
					</a>
				</div>
			</div>
		</div>
